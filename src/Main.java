...
//
//        try {
//            produtosService.cadastrarProduto(new Produto("Arroz Branco Tipo 1", "7891234560011", 8.99, 6.50, 300));
//        } catch (RuntimeException e) {
//            System.out.println(e.getMessage());
//        }
//
//        try {
//            produtosService.cadastrarProduto(new Produto("Feijão Carioca 1kg", "7891234560028", 6.49, 4.20, 250));
//        } catch (RuntimeException e) {
//            System.out.println(e.getMessage());
//        }
//
//        try {
//            produtosService.cadastrarProduto(new Produto("Macarrão Espaguete 500g", "7891234560035", 4.29, 2.80, 400));
//        } catch (RuntimeException e) {
//            System.out.println(e.getMessage());
//        }
//
...
//        try{
//            produtosService.cadastrarProduto(new Produto("", "7891234560035", 4.29, 2.80, 400));
//
//        } catch (RuntimeException e) {
//            System.out.println(e.getMessage());
//        }
